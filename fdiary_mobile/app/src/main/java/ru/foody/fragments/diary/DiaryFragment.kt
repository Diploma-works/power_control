...
import ru.foody.R
import ru.foody.fragments.StatsFragment
...
class DiaryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val statsBtn = view.findViewById<Button>(R.id.statsButton)
        statsBtn.setOnClickListener { showStats() }
    ...
    private fun showStats() {
        parentFragmentManager.beginTransaction()
            .replace(R.id.fl_wrapper, StatsFragment(recyclerViewAdapter.dataSet))
            .commit()
    }

...
class DiaryPositionsToViewHolderAdapter(
    ...
    private fun initContentCellText(
        ...
        diaryPositionVH.caloriesView.text =
            diaryPosition.nutrientInfo.calories.toString()
        diaryPositionVH.proteinView.text = diaryPosition.nutrientInfo.protein.toString()
        diaryPositionVH.carbsView.text = diaryPosition.nutrientInfo.carb.toString()
        diaryPositionVH.fatsView.text = diaryPosition.nutrientInfo.fat.toString()
